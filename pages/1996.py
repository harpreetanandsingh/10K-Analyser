...
if year in st.session_state:
    ...
    if 'business' in st.session_state[year]:
        if 'bullish' in st.session_state[year]['business']:
    ...
    if 'risk' in st.session_state[year]:
        if 'bullish' in st.session_state[year]['risk']:
    ...
    if 'mda' in st.session_state[year]:
        if 'bullish' in st.session_state[year]['mda']:
    ...
    if '7a' in st.session_state[year]:
        if 'bullish' in st.session_state[year]['7a']:
